---
title: "Eye-Tracking and Cognition (ETC)"
subtitle: 'Opensesame templates'
author: Matt Green
date: Sept 2019
output:
  html_document:
...
<!-- * [visual search kf variant, paired participants](https://github.com/mjgreen/opensesame_examples/raw/master/visual-search-kf.zip) -->
<!-- -- i can't remember what this variant does now -->
...
-- The experiment shows a website and collects a keyboard response as a rating. The provided stimuli are screenshots of websites, but this template would also be suitable for presenting any kind of still images for which you want to collect a keyboard response (e.g., faces with ratings of attractiveness; crowd scenes with/without threat objects). 
...
<!-- * [pro- and anti-saccade task](https://github.com/mjgreen/opensesame_examples/raw/master/pro-saccade_anti-saccade_tessa.osexp) -->
<!-- -- a variant of the pro-anti saccade task that tessa used -->
